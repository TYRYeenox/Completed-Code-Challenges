    ...
    for i in 0..<sortedNumbers.count {
        for j in 0..<sortedNumbers.count - 1 {
            if sortedNumbers[j] > sortedNumbers[j + 1] {
                let firstNumber = sortedNumbers[j]
                let secondNumber = sortedNumbers[j + 1]
                
                sortedNumbers[j] = secondNumber
                sortedNumbers[j + 1] = firstNumber
            }
        }
    }
