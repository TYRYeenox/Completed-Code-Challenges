...
class ParkingLot {
    ...
    func collectFee(parkingSpace: Int) {
        ...
        switch parkingSpace {
        case 1: charge = Double(parkingSpace1.count)
        case 2: charge = Double(parkingSpace2.count)
        case 3: charge = Double(parkingSpace3.count)
        case 4: charge = Double(parkingSpace4.count)
        case 5: charge = Double(parkingSpace5.count)
        case 6: charge = Double(parkingSpace6.count)
        case 7: charge = Double(parkingSpace7.count)
        case 8: charge = Double(parkingSpace8.count)
        case 9: charge = Double(parkingSpace9.count)
        case 10: charge = Double(parkingSpace10.count)
        case 11: charge = Double(parkingSpace11.count)
        case 12: charge = Double(parkingSpace12.count)
        case 13: charge = Double(parkingSpace13.count)
        case 14: charge = Double(parkingSpace14.count)
        case 15: charge = Double(parkingSpace15.count)
        case 16: charge = Double(parkingSpace16.count)
        case 17: charge = Double(parkingSpace17.count)
        case 18: charge = Double(parkingSpace18.count)
        case 19: charge = Double(parkingSpace19.count)
        case 20: charge = Double(parkingSpace20.count)
        default: return
        }
        
        cashCollected += charge
    }
}

let lot = ParkingLot()
lot.parkCar("Ford Pinto", parkingSpace: 1)
lot.giveTicket(parkingSpace: 1)
lot.collectFee(parkingSpace: 1)
print(lot.parkingSpace1)
print(lot.cashCollected)
